...
users_table = pd.DataFrame({
    'cil': ['1071324-101', '12345678', '3095678-303', '4017890-404', '5029012-505'],
    'name': ['Abdenbi EL MARZOUKI', 'فاطمة الزهراء', 'محمد الإدريسي', 'خديجة العلوي', 'يوسف السباعي'],
    'address': ['967, Lot. Sala Al Jadida Zone (1), Sala Al Jadida', 'حي المحمدي، الرباط', 'شارع محمد الخامس، فاس', 'حي النخيل، مراكش', 'شارع الزرقطوني، طنجة'],
    'phone': ['0612345678', '0698765432', '0611223344', '0655667788', '0699887766'],
    'service_type': ['ماء وكهرباء', 'كهرباء', 'ماء', 'كهرباء', 'ماء وكهرباء'],
    'zone_id': [1, 2, 1, 3, 2],
